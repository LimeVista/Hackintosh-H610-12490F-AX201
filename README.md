...
适用于 铭瑄 MS-H610-ITX + 12490F + RX560 的 OpenCore 0.8.8 黑苹果引导文件，机型 MacPro7,1  
OpenCore 0.8.8 for MAXSUN MS-H610-ITX + i5 12490F + RX560  

## 当前系统版本（Current OS Version）
macOS Ventura

## 下载（Download）
[Github Releases](https://github.com/LimeVista/Hackintosh-H610-12490F-AX201/releases)
